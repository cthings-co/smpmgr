...
def options(
    ...
    wirepas: int = typer.Option(None, help="The Wirepas addres to connect to"),
    ...
    ctx.obj = Options(timeout=timeout, transport=TransportDefinition(port=port, ble=ble, wirepas=wirepas), mtu=mtu)
    logger.info(ctx.obj)
